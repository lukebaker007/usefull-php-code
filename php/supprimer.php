...
<tr>
<?php 
echo'<td><a href="function_supprimer.php?supp='.$row['id_cl'].'" onclick="return(confirm(\'Etes-vous sur de vouloir supprimer cet client?\'));"><img src="images/supp.png"></a></td>'?>

<td><font size="+1"><strong>
<?php echo $row["id_cl"];?></strong></font>
</td>
<td><font size="+1"><strong>
...
<tr>
<?php 
echo'<td><a href="function_supp.php?supp='.$row['id_form'].'" 
onclick="return(confirm(\'Etes-vous sur de vouloir supprimer cet formation?\'));"><img src="images/supp.png"></a></td>'?>
